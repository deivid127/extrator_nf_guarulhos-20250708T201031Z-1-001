...
class Config:
    DEBUG = True
    SECRET_KEY = 'chave-final-para-o-projeto'
...
def upload_file():
    if request.method == 'POST':
        ...
        if not uploaded_files:
            ...
            # Redireciona para a página de conversão, onde a mensagem aparecerá
    ...
    # A rota GET inicial agora serve a página de upload
